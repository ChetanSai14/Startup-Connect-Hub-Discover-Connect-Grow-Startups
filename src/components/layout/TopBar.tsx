    ...
    <header className="h-16 border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-40">
      <div className="flex items-center justify-between h-full px-6">
        ...
        <div className="relative w-full max-w-md">
          ...
          <Input
            placeholder="Search startups, investors, jobs..."
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuItem className="flex flex-col items-start gap-1 p-3">
                <p className="font-medium text-sm">New investor match!</p>
                <p className="text-xs text-muted-foreground">
                  Sequoia Capital is interested in your startup
                </p>
              </DropdownMenuItem>
              <DropdownMenuItem className="flex flex-col items-start gap-1 p-3">
                <p className="font-medium text-sm">Meeting scheduled</p>
                <p className="text-xs text-muted-foreground">
                  Demo day presentation tomorrow at 2 PM
                </p>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
            ...
            <DropdownMenuContent align="end" className="w-56">
              <DropdownMenuLabel className="font-normal">
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">john@startup.com</p>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
